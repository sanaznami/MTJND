...
def create_model():
    ...
    JNDModel = Model(inputs=base_model.input, outputs=[J])
    return JNDModel

def train_model(JNDModel, X_Train, train_labels, X_Valid, valid_labels, checkpoint_path, csv_log_path, learning_rate, batch_size, epochs, jnd_column):
...
def test_model(JNDModel, X_Test, test_labels, result_path, model_weights_path, jnd_column):
...
def main(base_command, data_dir, checkpoint_path, csv_log_path, result_path, learning_rate, batch_size, epochs, model_weights_path, jnd_column):
    ...
    if base_command == 'train':
        train_model(JNDModel, X_Train, train_labels, X_Valid, valid_labels, checkpoint_path, csv_log_path, learning_rate, batch_size, epochs, jnd_column)
    elif base_command == 'test':
        test_model(JNDModel, X_Test, test_labels, result_path, model_weights_path, jnd_column)
